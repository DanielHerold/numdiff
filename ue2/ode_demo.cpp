...
*/
  ofstream out1("netzwerk1.data");
   ofstream out2("netzwerk2.data");
   ofstream out3("netzwerk3.data");
   ofstream out4("netzwerk4.data");
  Netzwerk func1(1);
  Netzwerk func2(1000);
  Vector<> y0={0,0};

  ODESolver(func1, expl_euler, 0, y0, 1000, 0.00001, out1);
  ODESolver(func1, impl_euler, 0, y0, 1000, 0.001, out2);
  ODESolver(func2, expl_euler, 0, y0, 1000, 0.00001, out3);
  ODESolver(func2, impl_euler, 0, y0, 1000, 0.001, out4);
